...
export const Agenda = () => {
	...
	return (
		<div className="container">
			...
			<input type="text" onChange={(e) => actions.GetContact(e.target.value)} placeholder="Anakin"></input>
					...
					<div className="card mb-3" key={index}>
						...
						<div className="row g-0">
							<div className="col-md-4">
								<img src={ProfilePic} style={{ height: "200px" }} className="img-fluid rounded-start" alt="Profile Picture" />
							</div>
                    ...
                    <i className="m-1">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-map" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M15.817.113A.5.5 0 0 1 16 .5v14a.5.5 0 0 1-.402.49l-5 1a.502.502 0 0 1-.196 0L5.5 15.01l-4.902.98A.5.5 0 0 1 0 15.5v-14a.5.5 0 0 1 .402-.49l5-1a.5.5 0 0 1 .196 0L10.5.99l4.902-.98a.5.5 0 0 1 .415.103M10 1.91l-4-.8v12.98l4 .8V1.91zm1 12.98 4-.8V1.11l-4 .8zm-6-.8V1.11l-4 .8v12.98z"/>
									...
									<p className="card-text"><i className="m-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-phone" viewBox="0 0 16 16">
                      ...
                      <path d="M8 14a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/>
							...
							<div className=" justify-content-md-end col-md-3">
								...
								<button className="btn" type="button" onClick={() => actions.deleteContact(item.id)}>
                <i className="m-2">
